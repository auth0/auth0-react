...
**Changed**
- chore(deps): bump @auth0/auth0-spa-js minimum version to ^2.24.1 [\#1182](https://github.com/auth0/auth0-react/pull/1182) ([yogeshchoudhary147](https://github.com/yogeshchoudhary147))
...
**Added**
- feat: enforce IPSIE session_expiry ceiling on local session lifetime [\#1126](https://github.com/auth0/auth0-react/pull/1126) ([yogeshchoudhary147](https://github.com/yogeshchoudhary147))
...
**Changed**
- chore(deps): bump @auth0/auth0-spa-js from 2.18.2 to 2.18.3 [\#1068](https://github.com/auth0/auth0-react/pull/1068) ([dependabot[bot]](https://github.com/apps/dependabot))
- chore(deps): bump @auth0/auth0-spa-js from 2.18.0 to 2.18.2 [\#1065](https://github.com/auth0/auth0-react/pull/1065) ([dependabot[bot]](https://github.com/apps/dependabot))
