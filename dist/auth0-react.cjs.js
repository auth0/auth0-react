...
var Auth0Provider = function (opts) {
    ...
    var client = React.useState(function () { return new ac(toAuth0ClientOptions(clientOpts)); })[0];
    ...
    var getAccessTokenSilently = React.useCallback(function (opts) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return (React__default['default'].createElement(Auth0Context.Provider, { value: __assign(__assign({}, state), { buildAuthorizeUrl: buildAuthorizeUrl,
 ...
 */
var withAuth0 = function (Component) { return function (props) { return (React__default['default'].createElement(Auth0Context.Consumer, null, function (auth) { return (
// eslint-disable-next-line @typescript-eslint/ban-ts-ignore
// @ts-ignore
React__default['default'].createElement(Component, __assign({ auth0: auth }, props))); })); }; };
