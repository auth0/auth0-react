...
module.exports = {
  createProvider: function createProvider(opts) {
    ...
    provider.use(async (ctx, next) => {
      ...
      if (ctx && ctx.oidc && ctx.oidc.route === 'end_session_success') {
  ...
  createApp: function createApp(opts) {
    return createProvider(opts).app;
  }
} 
